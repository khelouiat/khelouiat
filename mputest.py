...
Count_ESC = [ESC , ESC_2, ESC_3, ESC_4, ESC_5, ESC_6]
pi = pigpio.pi()
...
pi.set_servo_pulsewidth(23, 1000)
pi.set_servo_pulsewidth(24, 1000)
time.sleep(4)
...
try:
    ...
    while sysExit.value:
        ...
        gyroXangle += gyro_rate_x
        totalAngleX.value = 0.98 * (totalAngleX.value + gyro['x'] * elapsedTime.value) + 0.02 * accel['x']
        totalAngleY.value = 0.98 * (totalAngleY.value + gyro['y'] * elapsedTime.value) + 0.02 * accel['y']
        print(gyro_rate_x)
        error = int(totalAngleX.value) - desiredAngle
